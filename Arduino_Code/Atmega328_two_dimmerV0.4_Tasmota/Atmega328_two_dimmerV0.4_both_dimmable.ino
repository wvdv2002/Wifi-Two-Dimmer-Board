...
//    Serial.println(serialReceived);
    ...
    {
      Serial.println("Status:" + String(Dimmer_width - dimming_one) + "," + String(Dimmer_width - dimming_two) + "," + String(regulator_value_one.substring(8, 10).toInt()) + "," + String(regulator_value_two.substring(8, 10).toInt()) + "\n");
    }
    if (serialReceived.substring(0, 7) == "Setled:")
    {
      digitalWrite(DLED_GREEN, !serialReceived.substring(7, 8).toInt());
      digitalWrite(DLED_RED, !serialReceived.substring(9, 10).toInt());
    }
